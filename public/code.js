...
function handleData(data) {
  ...
  // // Embarked & Survival *** come back to me pls ***
  // const embarkedAndSurvival = betterData.map(passenger => {
  //   const value = passenger.embarked
  //   console.log(value)
  //   const color = passenger.survived === 'Yes' ? 'red' : 'green'
  //   return { value, color }
  // })
  ...
  // currently broken ;( 
  // const embarkedAndSurvivalGraph = makeGraph(embarkedAndSurvival)
  // document.querySelector('body').appendChild(embarkedAndSurvivalGraph)
